...
<body class="overflow-x-hidden">
  ...
  <section class="px-6 md:px-12 lg:px-20 py-10" 
    ...
    <div class="flex flex-col md:flex-row items-center gap-10">
      ...
      <div class="flex-1">
        ...
        <button
          class="mt-8 md:mt-10 bg-white border-2 border-Hijau text-Hijau font-semibold px-6 py-3 rounded-lg shadow hover:bg-Hijau hover:text-white hover:scale-105 transition-transform duration-300">
          Explore The Earth
        </button>
      </div>
  ...
  <section class="px-6 md:px-12 lg:px-20 mt-16 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-6 md:space-x-8 mt-6 font-semibold font-p text-Ireng">
        <div><span class="block text-2xl md:text-3xl font-bold">1.245tn</span> Daily trash</div>
        <div><span class="block text-2xl md:text-3xl font-bold">66%</span> Organik</div>
        <div><span class="block text-2xl md:text-3xl font-bold">33%</span> Anorganik</div>
      </div>
    </div>
  </section>
  ...
  <section class="px-6 md:px-12 lg:px-20 mt-20 text-center">
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-8 mt-10">
      <div class="bg-gray-50 p-6 rounded-2xl shadow hover:shadow-lg hover:scale-105 transition-transform duration-300">
        ...
        <p class="text-sm text-gray-600 font-poppins">Common recyclables: paper, cardboard, plastic bottles, glass, aluminum cans, and metal.</p>
      </div>
      <div class="bg-gray-50 p-6 rounded-2xl shadow hover:shadow-lg hover:scale-105 transition-transform duration-300">
        ...
        <p class="text-sm text-gray-600 font-poppins">Use jars, containers, or boxes again before sending them to recycling.</p>
      </div>
      <div class="bg-gray-50 p-6 rounded-2xl shadow hover:shadow-lg hover:scale-105 transition-transform duration-300">
        ...
        <p class="text-sm text-gray-600 font-poppins">Take your recyclables to the nearest recycling center or waste bank.</p>
      </div>
    </div>
  </section>

  {{-- Fact Section --}}
  <section class="mt-20 flex flex-col md:flex-row">
    <img src="{{ asset('img/Rectangle 5.png') }}" class="w-full md:w-1/2 h-auto object-cover" alt="Nature" />
    <div class="bg-gray-100 w-full flex items-center">
      <div class="text-left text-Ireng p-6 md:p-10">
        ...
        <p class="mt-4 font-medium font-p text-sm md:text-base">Starting with ourselves, let's implement recycling in our daily lives.
           By separating organic and inorganic waste, we reduce the volume of waste piling</p>
        <p class="mt-4 font-medium font-p text-sm md:text-base">Indonesia faces a complex waste problem with increasing volumes of waste
  ...
  <section class="px-6 md:px-12 lg:px-20 mt-20 grid md:grid-cols-2 gap-10 md:gap-20 items-center">
    ...
    <div class="flex justify-center">
      <img src="{{ asset('img/Purpose.png') }}" alt="Cleaning" class="rounded-xl shadow-lg w-full md:w-4/5 h-auto" />
    </div>
  </section>
