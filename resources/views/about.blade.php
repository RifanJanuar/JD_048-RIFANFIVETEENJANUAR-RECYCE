    ...
    <section class="px-6 md:px-20 py-10 items-center"
        ...
        <div class="flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="md:w-1/2 flex justify-center">
                <img src="{{ asset('img/bumiabout.png') }}" alt="planet" class="max-w-xs md:max-w-md lg:max-w-lg h-auto" />
            </div>
        </div>
    </section>
    ...
    <section class="px-6 md:px-20 mt-10 py-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
            <h2 class="text-2xl md:text-4xl font-bold font-poppins text-Ireng text-center md:text-left leading-snug">
                Building a <span class="text-Hijau">Greener Future</span> <br class="hidden md:block"> Together Forever
            </h2>
            <p class="text-gray-600 mt-6 md:mt-10 font-medium font-p text-sm md:text-base text-center md:text-left">
                Garbage isn't just something we throw away every day, but rather a significant responsibility that we
                 must manage properly. If left to accumulate without proper processing, it can pollute the air, soil, 
                 and atmosphere. However, when managed through the principles of reduction, reuse, and recycling, waste
                  can become a new resource that benefits human life and the environment.
            </p>
    ...
    <section class="px-6 md:px-24 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 py-10">
            <div class="text-center md:text-left">
                <h4 class="text-2xl md:text-4xl font-bold text-Ireng font-poppins">Tree Re-<span class="text-Hijau">Cycle</span></h4>
                <p class="text-gray-600 mt-3 text-sm md:text-base font-medium font-p">
                    A waste management method that aims to reduce the amount
                    of waste dumped into the environment by reducing the amount of waste produced.
                </p>
            </div>
            <div class="space-y-6">
...
<section class="grid md:grid-cols-2 gap-10 ml-9 px-8 md:px-16">
    ...
    <section class="px-6 md:px-20 py-14 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div class="text-center md:text-left">
            <h3 class="text-2xl md:text-3xl font-poppins text-Ireng font-bold">Contact <span class="text-Hijau">Us</span></h3>
            <p class="mt-4 text-sm md:text-base">Re-Cyce is a digital platform designed to
        ...
        <div class="p-6 rounded-lg shadow-sm bg-gray-50 text-center md:text-left">
            ...
            <p class="text-gray-600 mt-2 text-sm font-p font-medium font-p">Get complete information by sending an email to:</p>
            <p class="font-bold font-poppins text-Ireng mt-2 break-all">JagoanDigit@gmail.com</p>
        </div>
    </section>
