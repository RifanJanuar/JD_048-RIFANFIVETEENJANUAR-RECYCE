<div x-data="{ scrolled: false, open: false }" x-init="window.addEventListener('scroll', () => { scrolled = window.scrollY > 20 })" class="sticky top-0 z-50 transition-all duration-500"
    ...
    <nav class="border-Ireng">
        <div class="flex flex-wrap items-center justify-between mx-auto py-4 px-4 sm:px-6 md:px-10 lg:px-20">
            ...
            {{-- Menu --}}
            <div class="w-full md:flex md:w-auto md:order-1" :class="open ? 'block' : 'hidden'">
                <ul
